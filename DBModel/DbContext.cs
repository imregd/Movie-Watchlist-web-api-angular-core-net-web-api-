...
namespace Movie_Watchlist_web_api__angular___core_net_web_api_.DBModel
{
    ...
    public class User
    {
        ...
        // public int Password { get; set; } // This is not used, but it is here for future use if needed
    ...
    {
        public string Username { get; set; } = ""; 
        public List<UserMoviesDTO> UserMovies { get; set; } = new List<UserMoviesDTO>(); // This is used to read the user data and return it to the frontend
